...
const CardFeatures = () => {
  ...
  const cardFeatures = [
    ...
    },
    {
      ...
      description: 'Easy to manage, complete, bring tasks together, and make your projects a success.',
    ...
    },
    {
      icon: testTubeImg,
      title: 'Resource Hub',
      description: 'This is a brief description... This is a brief description... This is a brief description...',
      link: '/features/fourth-card',
      color: 'bg-[#FF87AA]',
      btnColor: 'bg-[#EE638C]'
    }
    ...
    <div className="flex flex-col items-center gap-3">
      <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-5 justify-center">
        {cardFeatures.map((cardFeature, index) => (
          <div key={index} className={`w-80 h-96 ${cardFeature.color} p-4 mb-8 flex flex-col justify-center border-[1px] border-black rounded-3xl relative`}>
            <div className="h-24 w-24  ">
              {cardFeature.icon && <img src={cardFeature.icon} alt="icon" className="h-full w-full object-contain p-2" />}
            </div>
