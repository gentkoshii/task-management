...
const Features = () => {
  ...
  const gradientStyle = darkMode
    ? { background: 'radial-gradient(circle at right, #2D3748, #1A202C 79%)', backgroundSize: 'cover' }
    : { background: 'radial-gradient(circle at right, #739dff, #FFFF 79%)', backgroundSize: 'cover' };
    ...
    <section style={gradientStyle} className="py-12">
      <div className="container mx-auto px-4">
        <h2 className={`text-4xl font-bold text-center mb-12 ${headingClass}`}>
          Effortless Task Management, <br />Seamless Collaboration
        </h2>
        ...
        <div className="flex flex-wrap items-center mb-20">
          ...
          <div className="w-full md:w-1/2 p-10">
            <h2 className={`text-3xl mb-4 ${headingClass}`}>Collaboration</h2>
            <p className={textClass}>
              Share your tasks with others and work together seamlessly.
