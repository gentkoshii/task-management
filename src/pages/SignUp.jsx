  ...
  return (
    ...
    <div className={`${display} w-screen h-full `}>
      <div className={`${display} w-[400px] h-[500px] rounded-4`}>
        <form onSubmit={handleSubmit} className={`${display} flex-col gap-3 absolute z-1`}>
      ...
      <div className={`${fadeOut} w-[400px] h-[400px] top-[5%] right-[8%]`}></div>
      <div className={`${fadeOut} w-[300px] h-[300px] bottom-[7%] left-[30%]`}></div>
      <div className={`${fadeOut} w-[500px] h-[500px] top-[5%] left-[5%]`}></div>
