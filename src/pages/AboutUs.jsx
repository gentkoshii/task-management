    ...
    return (
        <div className="w-screen h-full flex flex-col items-center justify-center gap-12 md:gap-28 pt-12 md:pt-28 pb-12 md:pb-28 overflow-hidden" style={gradientStyle}>
            <div className="w-[90%] md:w-[75%] lg:w-[55%] h-full flex flex-col gap-6 relative">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start w-full mb-9">
                    <div className="flex flex-col gap-3">
                        <h1 className="text-2xl md:text-4xl font-bold mb-1">About TaskFlow</h1>
                        <p className="text-base md:text-lg text-gray-700">What’s behind the boards.</p>
                    </div>
                    <div className="header-img w-full md:w-[30%] lg:w-[30%] xl:max-w-xs mt-4 md:mt-0">
                        <img src="Screenshot_4-Photoroom.png" alt="icon" className="w-full h-auto"/>
                    </div>
                </div>
            ...
            <div className="w-[90%] md:w-[75%] lg:w-[55%] h-full flex flex-col gap-2">
                <h2 className="text-xl md:text-2xl font-bold mb-2">A Brief History of TaskFlow</h2>
                <p className="text-sm md:text-base text-gray-700">
            ...
            <div className="w-[90%] md:w-[75%] lg:w-[55%] h-full flex flex-col gap-2">
                <h2 className="text-xl md:text-2xl mb-2">Millions of people and companies of all kinds and sizes love using TaskFlow.</h2>
                <p className="text-sm md:text-base text-gray-700">
                ...
                <div className="flex justify-center gap-5 mt-6">
                    <a href="#" className="text-xl md:text-2xl text-black"><i className="fab fa-twitter"></i></a>
                    <a href="#" className="text-xl md:text-2xl text-black"><i className="fab fa-google"></i></a>
                    <a href="#" className="text-xl md:text-2xl text-black"><i className="fab fa-instagram"></i></a>
                    <a href="#" className="text-xl md:text-2xl text-black"><i className="fab fa-youtube"></i></a>
                    <a href="#" className="text-xl md:text-2xl text-black"><i className="fab fa-facebook"></i></a>
                </div>
            </div>
        </div>
    );
